...
# The holds live in holds.py so the scorer builds episodes the same way this
# does. They used to live here, and the scorer grew its own idea of what a
# demonstration was.
from holds import (ASSIGNED, COLOUR_ARGS, COLOUR_NAME, _asks_for_colour,
                   _caller_site, _fix_colours, _is_case_pool, _maker_palette,
                   _maker_plan, _HeldColours, _PlannedCases, _PlannedCounts)
